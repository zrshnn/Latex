...
\subsubsection{3.1.1.2 Resarch Locale}
...
\begin{longtable}{p{4cm} p{4.8cm} p{4cm}}
	...
	LCD Display & Display Type & 16X2 Characters \\
	& Interface & I2C \\
...
\begin{figure}[H]
	...
	\label{fig:circuit}
	\includegraphics[width=0.8\textwidth]{figures/schematic_station.png}
\end{figure}
...
Figure 3.18 illustrates the 3D front view of the detachable power source used in the system. This view represents what community residents see upon renting the unit. The front panel integrates multiple AC outlets, USB charging ports, an indicator display for real-time status monitoring, and control buttons designed for efficient power management and user interaction.
...
Figure 3.19 shows the 3D design of the detachable power source used in the system, viewed from an aerial perspective. It has an overall dimension of 10.04 inches in length, 7.20 inches in height, and 7.09 inches in width, which is based on the actual size and arrangement of the components and materials used. At the top of the unit, a holder strap is provided, allowing users to conveniently hold and carry the detachable power source anywhere and at any time.
...
\begin{figure}[H]
	...
	\label{fig:activity}
	\includegraphics[width=0.35\textwidth]{figures/activity.png}
\end{figure}
